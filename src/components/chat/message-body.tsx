...
export function MessageBody({ text, isStreaming, products }: MessageBodyProps) {
  ...
  useEffect(() => {
    ...
    // === PRIMARY: Hydrate <cart-chip data-idx="N"> placeholders from AI ===
    let chipCount = 0;
    ...
    // === FALLBACK: DOM-based extraction (for messages without product chips) ===
    if (chipCount === 0) {
      // 1. TABLE ROWS
